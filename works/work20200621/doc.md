...
<img src="./img/cs3c_p_gainD_distribution.png" width = "100%"> 
Figure 4.3.1(a): the learning curve of the trained derivative gains

<img src="./img/cs3c_p_gainP_distribution.png" width = "80%"> 
...
<img src="./img/cs3c_error_features_boxplot2.png" width = "40%"> 
Figure 4.3.2(a): the learning curve of the error

<img src="./img/cs3c_rise_time_boxplot.png" width = "100%"> 
